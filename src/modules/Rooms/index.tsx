...
import { openCreateRoomPopup, openDuplicateFloorPopup } from "./store/roomPopupSlice";
...
import DuplicateFloorPopup from "./components/DuplicateFloorPopup";
...
function Rooms() {
  ...
  const handleDuplicateFloorClick = () => {
    dispatch(openDuplicateFloorPopup());
  };
      ...
      <section className="rooms">
        <div className="rooms__up-container">
          ...
          <div className="rooms__button-box">
            <button className="rooms__button" type="button" onClick={handleDuplicateFloorClick}>
              Дублировать этаж
            </button>
            <button className="rooms__button rooms__button_csv" type="button" onClick={downloadCSV}>
              Выгрузить в CSV
            </button>
            <button className="rooms__button" type="button" onClick={handleUpdateProjectClick}>
              Редактировать проект
            </button>
            <button className="rooms__button" type="button" onClick={handleCreateRoomClick}>
              Создать помещение
            </button>
          </div>
        </div>
